...
public class DateExceptionTest {
	...
	public static List<Integer[]> data(){
		...
		params.add(new Integer[] {9000, 13, 45, 0, 0, 0});
		params.add(new Integer[] {2000, 2, 30, 0, 0, 0});
		params.add(new Integer[] {2001, 4, 31, 0, 0, 0});
		params.add(new Integer[] {2002, 3, 32, 0, 0, 0});
		params.add(new Integer[] {2000, -1, 4, 0, 0, 0});
		params.add(new Integer[] {2001, 2, 29, 0, 0, 0});
