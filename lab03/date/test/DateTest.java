...
class DateTest {
  ...
  void nextDate_tc21() {
    Date today = new Date(3456, 12, 31);
    assertNotEquals(today, today.toString());
  }

  @Test
  void nextDate_tc22() {
    Date today = new Date(2005, 4, 15);
    Date expectedTomorrow = new Date(2020, 7, 20);
  ...
  void nextDate_tc23() {
    Date today = new Date(2005, 4, 15);
    Date expectedTomorrow = new Date(2005, 4, 25);
    assertNotEquals(expectedTomorrow, today.nextDate());
  }
  ...
  void nextDate_tc24() {
    Date today = new Date(2005, 4, 15);
    Date expectedTomorrow = new Date(2005, 6, 16);
    assertNotEquals(expectedTomorrow, today.nextDate());
  }
